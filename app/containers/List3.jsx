...
//newStyle=Object.assign(newStyle,swiperStyle );
...
export default class List extends React.Component {
   constructor(props,context){
     super(props,context);
     this.state={"list_header_ad":"","card":{},"plistData":[],"wraplistData":[],"hotData":[]}
         ...
         <div className={cx("main-body")}>
           ...
           <div className={cx("list-left")}>
             ...
             <div className={cx("card-div")}>
               <a href={this.state.card.url} target={this.isMobile()?'_self':'_blank'}>
                 <Card>
                   <CardMedia>
                     <img src={this.state.card.imgUrl} />
                   </CardMedia>
                   <CardTitle title={this.state.card.title} subtitle={this.state.card.subtitle} />
                   <CardText>{this.state.card.desc}</CardText>
                 </Card>
               </a>
             </div>
